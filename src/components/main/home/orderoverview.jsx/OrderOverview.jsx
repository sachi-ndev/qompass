    ...
    <div className="w-full  border-[1px] border-[#d4d4d4] rounded-[8px] min-h-[30vh]">
      ...
      <div className=" py-3 flex flex-col w-full ">
        <div className="w-[100%] min-h-[1.6lh] bg-[#f4f9fc] text-[#121212] flex items-center  text-[13px] py-2" >
          ...
          <p className="px-2 shrink-0 w-[13%] whitespace-nowrap">Actual Weight </p>
          <p className="px-2 shrink-0 w-[14%] whitespace-nowrap">Volumetric </p>
          <p className="px-2 shrink-0 w-[12%] whitespace-nowrap">Product category </p>
          <p className="px-2 shrink-0 w-[10%] whitespace-nowrap">HAZMAT class </p>
          <p className="px-2 shrink-0 w-[10%] whitespace-nowrap">Action</p>
        </div>
      </div>
    </div>
  );
